...
|---|---|---|---|
| 수익화 방향 | monetization-advisor | `/pricing`, `monetization-strategy` | 당근·토스 맥락 + Price Elasticity 프레임워크 |
...
3. **L1이 두 결과 종합** 후 ben 보고 (5블록 리포트 의무)
...
- **ben은 슬래시 커맨드를 외울 필요 없음**. L1이 한국어 듣고 자동 라우팅
