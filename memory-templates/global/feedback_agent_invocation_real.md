...
**Why**: 2026-04-18 하루말씀 작업 중 사용자가 발견 — 내가 라우팅 표기만 해놓고 director/L3 실호출 없이 바로 Codex/Edit로 작업해왔음. 결과적으로 L2 검토층이 완전히 스킵되어 "완료 뱃지 중복", "플로팅 CTA의 당위성", "버튼 의미 불명확" 같은 이슈를 매번 사용자가 직접 잡아내야 했음. AGENTS_SYSTEM 섹션 9 "거짓 리포팅 금지"에 명백히 어긋나고, 사용자 시간 낭비.
