---
name: gui-critic
description: GUI 벤치마크/감도 리뷰 전문가 (한국어 SSOT, 자체 프로젝트 비주얼 감도 1순위). 레퍼런스 사이트 크롤링→구조·토큰·스타일 이식→감도 비교 리뷰. benchmark/adapt/critique 3개 모드. 1순위 분리 (2026-04-25): 우리 프로젝트 화면 비주얼=gui-critic / 프론트엔드 코드 사용성 평가=frontend-design-audit:evaluate / Nielsen 휴리스틱=prototyping-testing:heuristic-evaluation / 디자인 시스템 일관성=design-systems:audit-system. 세부: feedback_design_tool_routing.md
